...
export class ArticleService{
  ...
  getFeedByTag(currentTag : string,limit:number=10,offset:number=0) {
    const url = this.urlForTagFeed + currentTag + "&limit="+limit + "&offset=" + offset
  ...
  favouriteArticle(slug:string) {
    https://conduit.productionready.io/api/articles/my-first-article-6gjm1f/favorite
